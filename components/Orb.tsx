...
export default function Orb({ hue = 0, hoverIntensity = 0.3, rotateOnHover = true, forceHoverState = false }) {
  ...
  useEffect(() => {
      ...
      uniforms: {
        ...
        iResolution: {
          value: new Vec3(
            ...
            (container?.clientWidth || 800) / (container?.clientHeight || 800),
          ),
        },
        hue: { value: hue },
        hover: { value: 0 },
    ...
    // Get the parent container that should handle hover events
    const hoverContainer = container.closest(".w-\\[600px\\]") || container.parentElement || container
    ...
    // Add event listeners to the hover container instead of just the canvas container
    ...
    // Also add to the container itself as backup
    ...
    return () => {
      ...
      hoverContainer.removeEventListener("mousemove", handleMouseMove)
