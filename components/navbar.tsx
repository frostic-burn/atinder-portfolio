...
// ✅ GlitchText component (only for actual strings, like your name)
const GlitchText = ({
  children,
  text,
  speed = 1,
            ...
            >
              {navLinks.map((link, index) => (
                ...
                >
                  <Link
                    href={link.href}
                    className="text-gray-300 hover:text-white py-3 px-4 transition-colors duration-300 text-lg block"
                    onClick={(e) => scrollToSection(e, link.href)}
                  >
                    {link.name}
                  </Link>
