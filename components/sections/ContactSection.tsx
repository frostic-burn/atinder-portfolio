...
const ContactSection = () => {
  ...
  return (
    <div className="py-12 md:py-20 relative min-h-screen">
              ...
              <div className="bg-black bg-opacity-60 backdrop-blur-lg p-4 md:p-6 lg:p-8 rounded-2xl border border-gray-800 border-opacity-50 shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                  ...
                  <button
                    ...
                    className={`w-full font-semibold py-2.5 md:py-3 px-4 md:px-6 rounded-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none text-sm md:text-base ${
                      showResumeHint
