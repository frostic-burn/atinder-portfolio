...
export const metadata: Metadata = {
  ...
  authors: [{ name: "Atinderpal Singh", url: "https://atinderpal-singh.vercel.app" }],
  ...
  return (
    <html lang="en">
      <head>
            ...
            __html: `
              (function() {
                function removeV0Branding() {
                  try {
                    const v0Elements = document.querySelectorAll('[id*="v0-built-with"], [class*="v0-built-with"]');
                    v0Elements.forEach(el => {
                      if (el && el.parentNode) {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: "https://atinderpal-singh.vercel.app",
              image:
                "https://ik.imagekit.io/cacl2snorter/WhatsApp%20Image%202025-07-13%20at%2021.02.00_d76b459d.webp?updatedAt=1752421638768",
        ...
        {/* Canonical URL */}
        <link rel="canonical" href="https://atinderpal-singh.vercel.app" />
      </head>
